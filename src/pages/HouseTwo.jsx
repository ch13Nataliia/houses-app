        ...
        <div className="lg:col-span-2 md:col-span-2 sm:col-span-1">
          ...
          <div className="mt-20" id="tab_menu">
            <div className="flex gap-2 w-fit" id="tabs_titles">
              <div className=" bg-orange-100/50 font-bold lg:text-xl sm:text-xl p-4 cursor-pointer ">
                Full Details
              </div>
              <div className=" bg-orange-400 text-white  font-bold lg:text-xl sm:text-xl p-4 cursor-pointer">
                Floor Plans
              </div>
              <div className=" bg-orange-400 text-white font-bold lg:text-xl sm:text-xl p-4 cursor-pointer">
                Area Map
